...
public abstract class Hilt_FakeCallReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((FakeCallReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectFakeCallReceiver(UnsafeCasts.<FakeCallReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
